        ...
        <div class="flex justify-evenly flex-wrap gap-y-4">
            <div
                ...
                <div class="text-lg font-bold flex justify-center flex-col items-center">
                    <a href="{{route('admin.renter-owner-list')}}" class=" inline-block no-underline text-black">Users</a>
            ...
            <div
                ...
                <div class="text-lg font-bold flex justify-center flex-col items-center">
                    <a href="{{route('admin.user-posts')}}" class=" inline-block no-underline text-black">User Posts</a>
            ...
            <div
                ...
                <div class="text-lg font-bold flex justify-center flex-col items-center">
                    <a href="{{route('admin.transactions')}}" class=" inline-block no-underline text-black">transactions</a>
            ...
            <div
                ...
                <div class="text-lg font-bold flex justify-center flex-col items-center">
                    <a href="{{route('admin.properties')}}" class=" inline-block no-underline text-black">Properties</a>
            ...
            <div
                ...
                <div class="text-lg font-bold flex justify-center flex-col items-center">
                    <a href="{{route('admin.townships')}}" class=" inline-block no-underline text-black">Townships</a>
